...
s0_names = Browser;Chat;Coding;Other;
...
[core]
s0_active_plugins = core;composite;opengl;place;resize;compiztoolbox;move;session;put;snap;commands;text;grid;copytex;wall;regex;animation;imgpng;expo;unitymtgrabhandles;vpswitch;workarounds;mousepoll;workspacenames;ezoom;staticswitcher;fade;scale;unityshell;
...
s0_outputs = 1920x1200+1920+0;1920x1200+0+0;
...
s0_put_next_output_key = <Control><Alt>KP_0
